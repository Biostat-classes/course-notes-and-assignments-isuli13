...
ggplot(sleep[sleep$BrainWt <1000, ], aes(x=BrainWt, y = TotalSleep)) +
  ...
  ggtitle("Time spent sleeping \n decreases with brain \n 
weight") +
  scale_color_manual(name="Type of mammal", values = c("#EEA373", "#50486D"))
...
ggplot(sleep
  ...
  geom_histogram() +
  xlab("Brain weight (g)") +
  ggtitle("Total sleep (hoursper day")+ggtitle("Variation in levels") +
  theme(axis.title.x = element_text(face="bold", size=28), 
        axis.title.y = element_text(face="bold", size=28), 
        axis.text.y  = element_text(size=20),
        axis.text.x  = element_text(size=20), 
...
A 95% confidence interval suggests there is a 95% certainty that the
values include the true mean of the population.
